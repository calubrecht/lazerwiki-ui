...
export default function TextArea(props) {
  let className = props.className ? props.className : "TextArea";
...
TextArea.propTypes = {
  className: PropTypes.string, name: PropTypes.string, label: PropTypes.string,  varName: PropTypes.string, value: PropTypes.string, visible: PropTypes.bool, disabled: PropTypes.bool, autofocus: PropTypes.bool,  onChange: PropTypes.func
};
